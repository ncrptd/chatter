    ...
    <header className="col-span-2 hidden md:block text-2xl header h-screen">
      <div className="py-2 flex flex-col justify-between h-full">
        <div className='h-full'>
          ...
          <ul className="flex flex-col justify-start gap-8 text-base">
            <NavLink to="/">
            ...
            <li className="flex flex-col gap-2 items-center justify-center cursor-pointer " onClick={handleLogout} >
              <svg xmlns="http://www.w3.org/2000/svg" width="40"
                height="40" viewBox="0 0 24 24"><path fill="currentColor" d="M5 21q-.825 0-1.413-.588T3 19V5q0-.825.588-1.413T5 3h7v2H5v14h7v2H5Zm11-4l-1.375-1.45l2.55-2.55H9v-2h8.175l-2.55-2.55L16 7l5 5l-5 5Z" /></svg>
              Logout
            </li>
          </ul>
        </div>
