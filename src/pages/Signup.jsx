...
export default function Signup() {
  ...
  const validateFormDetails = () => {
    const { firstName, lastName, username, password } = formDetails;
    if (firstName === '') {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      toastError('Signup failed please try later')
    }
  };
  return (
    <main className=" p-4 w-full ">
      ...
      <form
        className="container mx-auto flex flex-col justify-center item-center  px-8 py-2 md:w-2/5 rounded-2xl shadow-2xl text-base gap-2 "
      ...
      >
        ...
        <div className="flex justify-between items-center">
          ...
          />
          <div
            className="rounded-sm p-2  bg-slate-900 cursor-pointer"
            onClick={() => {
              setShow((prev) => {
        ...
        <button
          className="bg-pink-600 text-white
           py-1 px-4 w-full  shadow-2xl rounded-full mb-2"
          type="submit"
        >
          Create New Account
        </button>
